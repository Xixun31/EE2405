...
erpc_status_t LEDBlinkService_service::handleInvocation(uint32_t methodId, uint32_t sequence, Codec * codec, MessageBufferFactory *messageFactory)
{
    ...
    switch (methodId)
    {
        ...
        case kLEDBlinkService_read_led_id:
        {
            erpcStatus = read_led_shim(codec, messageFactory, sequence);
            break;
        }
...
// Server shim for read_led of LEDBlinkService interface.
erpc_status_t LEDBlinkService_service::read_led_shim(Codec * codec, MessageBufferFactory *messageFactory, uint32_t sequence)
{
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (err == kErpcStatus_Success)
    {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, kLEDBlinkService_service_id, kLEDBlinkService_read_led_id, sequence);
