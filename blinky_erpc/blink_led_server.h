...
private:
    ...
    /*! @brief Server shim for read_led of LEDBlinkService interface. */
    erpc_status_t read_led_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
};
