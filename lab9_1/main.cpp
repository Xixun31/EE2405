...
void playNoteD(void) { idD = queue.call_every(1ms, playNote, 147, 1); }
void playNoteF(void) { idF = queue.call_every(1ms, playNote, 175, 1); }
void playNoteA(void) { idA = queue.call_every(1ms, playNote, 220, 1); }
